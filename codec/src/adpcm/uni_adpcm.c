...
/*len: indata bytes*/
void adpcm_coder(unsigned short indata[], char outdata[], int len,
                 adpcm_state_t *state) {
  unsigned short *inp = NULL; /* Input buffer pointer */
...
/*len: indata bytes*/
void adpcm_decoder(char indata[], unsigned short outdata[], int len,
                   adpcm_state_t *state) {
  char *inp = NULL;                /* Input buffer pointer */
  unsigned short *outp = NULL;     /* output buffer pointer */
  int sign = 0;                    /* Current adpcm sign bit */
  int delta = 0;                   /* Current adpcm output value */
  int step = 0;                    /* Stepsize */
